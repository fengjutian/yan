      ...
      body: SafeArea(
        ...
        child: ListView(
          ...
          children: [
            ...
            _HeroCreateCard(onTap: () => context.go('/camera')),
            const SizedBox(height: 28),
            Row(children: [
            ...
            Row(children: [
              Expanded(
                  child: _InspirationCard(
                      ...
                      iconColor: const Color(0xFF667065),
                      title: '人物写真',
                      description: '保留你的独特气质',
              ...
              Expanded(
                  child: _InspirationCard(
                      ...
                      iconColor: const Color(0xFFC7793B),
                      title: '作品画廊',
                      description: '收藏每一次心动',
...
class _BrandMark extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: const [
            BoxShadow(
                color: Color(0x247B5152), blurRadius: 14, offset: Offset(0, 6))
          ],
        ),
  ...
  Widget build(BuildContext context) => Container(
        ...
        child: Row(mainAxisSize: MainAxisSize.min, children: [
          const Icon(Icons.brightness_5_rounded,
              color: Color(0xFFE6A33A), size: 16),
  ...
  Widget build(BuildContext context) => Container(
        ...
        child: const Row(children: [
          Icon(Icons.lightbulb_outline_rounded,
              color: AppColors.rose, size: 21),
          SizedBox(width: 12),
          Expanded(
              child: Text('今日灵感：试试加入「柔和光影」和「胶片质感」',
                  style: TextStyle(
